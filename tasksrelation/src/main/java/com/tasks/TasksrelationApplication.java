...
import com.tasks.entities.Gender;
import com.tasks.entities.User;
import com.tasks.entities.UserProfile;
import com.tasks.repo.UserProfileRepository;
import com.tasks.repo.UserRepository;

@SpringBootApplication
public class TasksrelationApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(TasksrelationApplication.class, args);
	}
